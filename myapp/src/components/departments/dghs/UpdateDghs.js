...
export default function UpdateDghs() {
    ...
    async function getdghs() {
        let result9 = await fetch(`http://localhost:5000/dghslist/${params.id}`);// jo jo saare product list hai isme empty array me store honge 
        ...
        setCard_No(result9.Card_No)
        setDate_Of_Issue(result9.Date_Of_Issue);
        setRemarks(result9.Remarks);
    }

    async function updatedghs(e) {
        e.preventDefault();
        ...
        let result11 = await fetch(`http://localhost:5000/dghslist/${params.id}`, {
            method: "PUT",
            ...
            body: JSON.stringify({ Name_Of_Official, Designation_Of_Official, Department, Card_No, Date_Of_Issue,Remarks })
        });
                        ...
                        <div class="form-content">
                            <div class="form-items ">
                                ...
                                <form>
                                    ...
                                    <div class="col-md-12">
                                        <input type="text" className='inputBox' value={Card_No} placeholder='enter Card No.' onChange={(e) => { setCard_No(e.target.value) }} style={{ fontWeight: "500" }} />
                                       
                                    </div>

                                    <div class="col-md-12">
                                        <input type="text" className='inputBox' value={Date_Of_Issue} placeholder='enter Date of issue ' onChange={(e) => { setDate_Of_Issue(e.target.value) }} style={{ fontWeight: "500" }} />
                                    ...
                                    <div class="mt-3">
                                        <button class="btn btn-primary" onClick={updatedghs} >Update</button>
                                    </div>
                                </form>
                            </div>
                        </div>
